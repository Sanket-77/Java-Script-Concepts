...
//variable are are started with avr keyword
...
undefine=> using it but not defined anywher 
...
*/
// Object => it will store multiple kind od data. it works with keay value pair.
...
var userdetail = { name: "testname", phonenumber: 9637967737, adress: "pune", telephonenumber: [416122, 876399, 978635], employeedetail: { empname: "tcs", empId: 83768 } };
...
document.write(arraywithobject.map((item) => { return "<div>" + item.name + "</div>"; }))
...
//type of keyword => type of keyword will help you to realise data tyepes
