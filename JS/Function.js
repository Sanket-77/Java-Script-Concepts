//**Function workingin javascript *//
// Function => Function is use to process the data in different kind of ways in single way. 
...
// ***  Anonymous Function => Anonymous it should not tack any kind of name this function. It just use function keyword only
// we can bind this function with object and variables 

var functionwithvar = function(){console.log("example of anonymous function")}

functionwith_object = {
    test: "test function",
    testmethod: function (){console.log("this is test function")}

}



// *** Self invokeFunction => It will exicute itself with the use of () only.
//syntax => (function({console.log()}))()
(function(){console.log("self invoke logic")})();
...
function firstcall(){console.log("first call back function")}
function secsecondcall(){console.log("second call back function")}
...
//return keyword will execute statment immediatly and stop further statment exicution and break the scope 
